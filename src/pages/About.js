...
const About = () => {
  return (
    <div className="about-page__div">
      ...
      <ul>
        <li>– The track name <b><span>copies to clipboard</span></b> on pressing the name.</li>
        <li>– Click on the key of any track to go to <b><span>recommended tracks</span></b>. This uses Spotify's song radio/generated tracks API to get tracks that are similar, and in a similar key/mode to the selected song.</li>
        <li>– Hover over the tooltip to see more track-related info. Note that the genres provided by Spotify are unfortunately artist specific rather than track, meaning they sometimes might be inaccurate. Welcome to the weird and wonderful world of Spotify's 4000+ genre classifications. Also note that if there are more than one artist, genres are only shown for the first.</li>
      </ul>
      ...
      <div className="camelot-info">
        ...
        <h4 className="info-header"><i>So what does this all mean in practice?</i></h4>
        <ul className="info-points">
          <li>– Those that share the same number but different letter can be mixed together easily, (they share the same notes but have a different <span>root</span> note // major to minor scale).</li>
          ...
          <li>– The further two numbers are away from another the harder they will be to mix 'naturally',</li>
      ...
      <div className="afterword">
        <hr />
        <p className="links-header">If you're interested, other Spotify-based sites that I've written can be found at:</p>
